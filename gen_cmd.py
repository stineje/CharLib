...
#	gen_comb("OSU350", cmd_file, "SEL2X1",  "SEL2",  ['IN0','IN1','SEL'],     ['Y'],  ['Y=((IN0&!SEL)&(IN1&SEL))'],    '1', 'NETLIST/SEL2X1.spi')
#	gen_seq ("OSU350", cmd_file, "DFFARX1", "DFF_PCPU_NR", ['DATA','CLK','NRST'], ['Q'], ['IQ','IQN'], ['Q=IQ','QN=IQN'], '1', 'NETLIST/DFFARX1.spi')
	gen_comb("OSU350", cmd_file, "INVX1",   "INV",   ['A'],             ['Y'], ['Y=!A'],         '1', 'NETLIST/INVX1.spi')
